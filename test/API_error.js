 ...
 * Common errors.
 */
test_API_taskAction_addurl_error_100_mock.description = "test_API_taskAction_addurl_error_100_mock";

function test_API_taskAction_addurl_error_100_mock() {
...
test_API_taskAction_addurl_error_101_mock.description = "test_API_taskAction_addurl_error_101_mock";

function test_API_taskAction_addurl_error_101_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":101},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Invalid parameter", "error_text");
}

test_API_taskAction_addurl_error_102_mock.description = "test_API_taskAction_addurl_error_102_mock";

function test_API_taskAction_addurl_error_102_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
...
test_API_taskAction_addurl_error_103_mock.description = "test_API_taskAction_addurl_error_102_mock";

function test_API_taskAction_addurl_error_103_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
...
test_API_taskAction_addurl_error_104_mock.description = "test_API_taskAction_addurl_error_104_mock";

function test_API_taskAction_addurl_error_104_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
...
test_API_taskAction_addurl_error_105_mock.description = "test_API_taskAction_addurl_error_105_mock";

function test_API_taskAction_addurl_error_105_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
...
test_API_taskAction_addurl_error_106_mock.description = "test_API_taskAction_addurl_error_106_mock";

function test_API_taskAction_addurl_error_106_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":106},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Session timeout", "error_text");
}

test_API_taskAction_addurl_error_107_mock.description = "test_API_taskAction_addurl_error_107_mock";

function test_API_taskAction_addurl_error_107_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
 ...
 * Task action errors.
 */
test_API_taskAction_addurl_error_400_mock.description = "test_API_taskAction_addurl_error_400_mock";

function test_API_taskAction_addurl_error_400_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":400},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "File upload failed", "error_text");
}

test_API_taskAction_addurl_error_401_mock.description = "test_API_taskAction_addurl_error_401_mock";

function test_API_taskAction_addurl_error_401_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":401},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Max number of tasks reached", "error_text");
}

test_API_taskAction_addurl_error_402_mock.description = "test_API_taskAction_addurl_error_402_mock";

function test_API_taskAction_addurl_error_402_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":402},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Destination denied", "error_text");
}

test_API_taskAction_addurl_error_403_mock.description = "test_API_taskAction_addurl_error_403_mock";

function test_API_taskAction_addurl_error_403_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":403},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Destination does not exist", "error_text");
}

test_API_taskAction_addurl_error_404_mock.description = "test_API_taskAction_addurl_error_404_mock";

function test_API_taskAction_addurl_error_404_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":404},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Invalid task id", "error_text");
}

test_API_taskAction_addurl_error_405_mock.description = "test_API_taskAction_addurl_error_405_mock";

function test_API_taskAction_addurl_error_405_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
    utils.writeTo('{"error":{"code":405},"success":false}', "fixtures/action.txt");
    doTaskAction(false, "Invalid task action", "error_text");
}

test_API_taskAction_addurl_error_406_mock.description = "test_API_taskAction_addurl_error_406_mock";

function test_API_taskAction_addurl_error_406_mock() {
    server.expect("/webapi/DownloadStation/task.cgi", 200, "/action.txt");
