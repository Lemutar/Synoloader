...
test_API_connect_succeed_mock.description = "test_API_connect_succeed_mock";

function test_API_connect_succeed_mock() {
    utils.writeTo('{"data":{"sid":"CONNECTION_ID"},"success":true}', "fixtures/connect.txt");
    doConnect(true, "CONNECTION_ID", "id");
}

test_API_connect_fail_400_mock.description = "test_API_connect_fail_400_mock";

function test_API_connect_fail_400_mock() {
...
test_API_connect_fail_401_mock.description = "test_API_connect_fail_401_mock";

function test_API_connect_fail_401_mock() {
    utils.writeTo('{"error":{"code":401},"success":false}', "fixtures/connect.txt");
    doConnect(false, "Account disabled", "error_text");
}

test_API_connect_fail_402_mock.description = "test_API_connect_fail_402_mock";

function test_API_connect_fail_402_mock() {
    utils.writeTo('{"error":{"code":402},"success":false}', "fixtures/connect.txt");
    doConnect(false, "Permission denied", "error_text");
}

test_API_connect_fail_403_mock.description = "test_API_connect_fail_403_mock";

function test_API_connect_fail_403_mock() {
...
test_API_connect_fail_404_mock.description = "test_API_connect_fail_404_mock";

function test_API_connect_fail_404_mock() {
