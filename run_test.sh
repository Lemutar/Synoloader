...
echo "TESTING"
if [ -z "$FirefoxTest" ];
then ./fire-test-runner --port=9999 --profile="firefox_profile" --quit ./test/;
else ./fire-test-runner --port=9999 --firefox="'$FirefoxTest'" --profile="firefox_profile" --quit ./test/;
fi
